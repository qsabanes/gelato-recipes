# Gelato de Chocolate (800g)

Sabor a chocolate negro directo, sin tableta, partiendo solo de cacao en polvo.

## Formulación

| Ingrediente | Cantidad (g) | Notas |
| :---- | :---- | :---- |
| **Leche Entera** | **470g** | Más leche para compensar la falta de líquido de la tableta. |
...
Mezcla todos los polvos (incluido el cacao) y añádelos a la leche y la nata a **50 °C**. Pasa el minipimer, sube a **85 °C** durante 1 minuto y deja madurar en la nevera **12 horas**.

> La versión 100% polvo da un sabor más limpio; una versión con tableta (70%) resultaría más pastosa.
